...
- 1 motorista ativo cadastrado em Colaboradores;
...
3. Um motorista só pode participar de um conjunto ativo por vez.
...
7. Trocas de motorista não apagam o motorista anterior. Elas geram um evento no histórico.
8. Desatrelar encerra o conjunto e libera cavalo, carreta e motorista para uma nova combinação.
...
2. Abra Conjuntos.
3. Monte cavalo A + carreta A + motorista A.
4. Verifique se os três somem das opções disponíveis.
5. Abra o conjunto ativo e troque para motorista B.
6. Verifique o histórico com usuário/data/hora.
7. Desatrele o conjunto.
8. Verifique se cavalo A, carreta A e motorista B voltaram às opções.
