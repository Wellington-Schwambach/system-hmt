...
const FIELD_LABELS: Record<string, string> = {
  ...
  shipper: 'embarcador',
  display_color: 'cor do embarcador',
  normalized_name: 'nome do embarcador',
  ...
  tractor_id: 'cavalo',
  trailer_id: 'carreta',
  driver_id: 'motorista do conjunto',
  coupled_at: 'data e horário do atrelamento',
  driver_assigned_at: 'data e horário do vínculo do motorista',
  driver_two_assigned_at: 'data e horário do vínculo do segundo motorista',
  assigned_at: 'data e horário da alteração do motorista',
  detached_at: 'data e horário do desatrelamento',
  reference_code: 'referência da carga',
  shipper_id: 'embarcador da carga',
  container_number: 'container',
  collection_city: 'cidade de coleta',
  loading_city: 'cidade de carregamento',
  delivery_city: 'cidade de baixa / entrega',
  scheduled_at: 'data e horário programados',
  stage: 'etapa da logística',
  position: 'posição do ticket',
